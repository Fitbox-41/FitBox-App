...
/// The real FitBox logo, over a soft red glow so it sits premium on the
/// gradient.
///
/// **One artwork, the owner's own**, on both themes. Its "Fit Sports" half is
/// silver, which reads beautifully on the dark theme and all but dissolves on
/// the light one. That used to be solved by recolouring the metal to graphite,
/// but that is not the brand's logo — so on light backgrounds the real artwork
/// now sits on a soft dark plate instead, which is what a silver mark is
/// designed for. The asset is generated by `tool/gen_logo_assets.py` — don't
...
class LogoBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget badge = Image.asset('assets/images/logo_mark.png',
